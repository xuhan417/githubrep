...
import carla
import math
from agents.navigation.agent_overtake import Agent
from agents.navigation.local_planner_behavior import LocalPlanner, RoadOption
from agents.navigation.global_route_planner import GlobalRoutePlanner
from agents.navigation.global_route_planner_dao import GlobalRoutePlannerDAO
from agents.navigation.types_behavior import Cautious, Aggressive, Normal_follow, Normal_overtake
...
class BehaviorAgent(Agent):
    ...
    def update_information(self, world):
        ...
        # print('Current speed limit is: ' + str(self.speed_limit))
    ...
    def _overtake(self, location, waypoint, vehicle_list):
        ...
        if (left_turn == carla.LaneChange.Left or left_turn == carla.LaneChange.Both) \
            ...
            new_vehicle_state, target_vehicle, distance = self._bh_is_vehicle_hazard(waypoint, location, vehicle_list, max(
    ...
    def car_following_manager(self, vehicle, distance, debug=False):
        ...
        # Under safety time distance, slow down. was 0.5
        # if 0.6*self.behavior.safety_time > ttc > 0.0:
        # increase following behavior 
        # if 0.7*self.behavior.safety_time > ttc > 0.0:
    ...
    def run_step(self, debug=False):
        ...
        # print('Current overtake counter: ' + str(self.behavior.overtake_counter))
        ...
        # Note: Determine conditions: 1.Ego in left lane. 2.Leading vehicle in right lane. 3.Minimum distance smaller than 10
